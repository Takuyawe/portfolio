    ...
    <div className="relative h-[70rem] w-full overflow-hidden flex justify-center">
      ...
      <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
        ...
        className="mt-0"
          ...
          autoFocus
        />
        <Typography className="mt-4 self-start" variant="subtitle1">Email</Typography>
        <TextField
        className="mt-0"
          inputRef={emailRef}
          margin="normal"
          ...
          autoFocus
        />
        <Typography className="mt-4 self-start" variant="subtitle1">Message</Typography>
        <TextField
        className="mt-0"
          inputRef={messageRef}
          margin="normal"
